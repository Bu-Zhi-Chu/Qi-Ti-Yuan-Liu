                                ...
                                children: [
                                    {
                                        ...
                                        styles: (() => {
                                            const meta = (blocksConfig as any[]).find((b) => b.type === 'FlexibleTableRow') as any
                                            return meta?.presetStyles ? { ...meta.presetStyles } : {}
                                        })(),
                                        attributes: { 'data-name': '表格表行', rowIndex: 0 },
                                        children: (() => {
