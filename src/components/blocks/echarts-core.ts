...
// 组件
import { GridComponent, TooltipComponent, LegendComponent, TitleComponent, MarkPointComponent, MarkLineComponent, ToolboxComponent, DataZoomComponent } from 'echarts/components'
// 渲染器
